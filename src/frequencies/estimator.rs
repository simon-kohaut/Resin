...
impl FoCEstimator {
    pub fn new(frequency: &f64) -> Self {
        ...
        let prediction_covariance = array![[1.0, 0.1], [0.1, 1.0]];
        let process_noise = array![[0.1, 0.01], [0.01, 0.1]];
        let sensor_noise = array![[0.001]];
    ...
    pub fn update(&mut self, elapsed: f64) -> f64 {
