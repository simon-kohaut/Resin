...
plot = sns.lineplot(data=results, hue="Shape", y="Value", x="Time", palette=sns.color_palette(), linewidth=0.5)
...
plot.get_figure().savefig("output/value_plot.pdf", bbox_inches='tight')
